...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans flex flex-col">
          ...
          <div className="animate-in fade-in duration-500">
            <ExplanationPanel
              ...
              indicators={[
                ...
                {
                  name: 'Botão: Ver Detalhes (O Investigador)',
                  desc: "Se encontrou uma despesa que subiu muito de repente no ranking, clique em 'Ver Detalhes'. Irá abrir um painel que mostra exatamente qual era o saldo daquela despesa, mês a mês, ao longo de todo o ano extraído.",
                },
              ]}
            />
      ...
      {/* --- MODAL DE DETALHES DA DESPESA (TOP 10) --- */}
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] flex flex-col overflow-hidden animate-in zoom-in-95 duration-200">
            <div className="p-6 border-b border-slate-100 flex justify-between items-center bg-white">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-xl font-bold text-slate-900">
                    Detalhes: {selectedExpenseDetail.nome}
                  </h3>
                  <p className="text-sm text-slate-500">
                    {selectedExpenseDetail.isGrouped
                      ? 'Agrupamento Personalizado'
                      : `Conta Analítica: ${selectedExpenseDetail.conta}`}
                  </p>
                </div>
              </div>
              <button
              ...
              {selectedExpenseDetail.isGrouped && (
                <div>
                  <h4 className="text-sm font-black text-slate-700 uppercase tracking-widest mb-4">
                    Composição do Grupo ({expensePeriod})
                  </h4>
                      ...
                      <thead className="bg-slate-50 border-b border-slate-200">
                        <tr>
                          ...
                          <th className="p-3 px-4 text-slate-500 font-bold uppercase text-[11px] tracking-widest text-right">
                            Valor Final no Período
                          </th>
                        </tr>
                      </thead>
                      <tbody className="divide-y divide-slate-100">
                        {selectedExpenseDetail.subAccounts.map((accCode) => {
                          const accObj = monthlyData.accounts.find((a: any) => a.conta === accCode)
                          const sld = accObj?.saldos[expensePeriod]
                          ...
                          return (
                            <tr key={accCode} className="hover:bg-slate-50">
                              ...
                              <td className="p-3 px-4 text-right font-bold text-slate-700">
                                R${' '}
